...
export default function JobForm({ onAddJob, isLoading }: JobFormProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-6">
      <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Add New Job Application</h2>
      ...
      <div className="mb-4">
        ...
        {scrapeError && (
          <p className="mt-1 text-sm text-red-600 dark:text-red-400">{scrapeError}</p>
        )}
      </div>
